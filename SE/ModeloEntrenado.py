...
def predecir_phylum(caracteristicas):
    ...
    etiquetas_phylum = ["Protozoarios", "Poriferos", "Cnidarios", "Ctenoforos", "Platelmintos", "Anelidos", "Moluscos", "Artrópodos", "Cordados"]
...
caracteristicas_ejemplo = [1, 0, 1, 0, 0, 0, 0]  # Cambiar según sea necesario
